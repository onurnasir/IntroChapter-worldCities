...
public class demo extends javax.swing.JFrame {
    ...
    public demo() {
        initComponents(); //Data modeli olarak geçerler.
        populateTable();
    }
    ...
    public ArrayList<City> getCities() throws SQLException {
        ...
        Statement statement = null; //Sorgu göndermek için statement ile yapıyoruz.
        ResultSet resultSet;
        ...
        try {
            ...
            statement.close(); //Finalde yani sonda sorguyu kapat.
            connection.close();// ve bağlantıyı sonlandır.
        }
        return cities;
    }
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addGroup(layout.createSequentialGroup()
                            .addContainerGap()
                            .addComponent(tbxDistrict, javax.swing.GroupLayout.PREFERRED_SIZE, 208, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                            .addGap(22, 22, 22)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(tbxCountryCode, javax.swing.GroupLayout.DEFAULT_SIZE, 214, Short.MAX_VALUE))
                            .addGap(18, 18, 18)
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        ...
        TableRowSorter<DefaultTableModel> tableRowSorter
                = new TableRowSorter<DefaultTableModel>(model);//Sorter filtreleme yapısı olarak kullanılmaktadır.
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try {
            ...
            statement.setInt(4, Integer.valueOf(tbxPopulation.getText())); //String alanı İnt çevirmek için bu şekilde kullanılır.
